...
const theme = ref<MultiSelectPassThroughOptions>({
    ...
    pcChip: {
        ...
        label: `text-sm`,
        removeIcon: `ml-1.5 w-3.5 h-3.5 cursor-pointer hover:text-blue-900 dark:hover:text-blue-100 transition-colors`
    },
    ...
    pcHeaderCheckbox: {
        root: `relative inline-flex items-center justify-center w-5 h-5 mr-2
            ...
            data-[p-checked=true]:bg-blue-600 data-[p-checked=true]:border-blue-600`,
