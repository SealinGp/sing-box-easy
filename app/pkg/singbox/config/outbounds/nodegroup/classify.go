...
// engine (app/pkg/singbox/config/outbounds/rules) is not configured. When rules are active (the
...
// app/pkg/singbox/config/outbounds/rules); retained only for the no-rules fallback path.
