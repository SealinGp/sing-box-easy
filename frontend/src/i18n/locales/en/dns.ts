...
export default {
  ...
  rules: {
    ...
    actionTypes: {
      ...
      evaluate: 'Evaluate - Query a server and save its response',
      respond: 'Respond - Return a saved evaluated response',
    },
    rejectMethods: {
    ...
    flow: {
      then: {
        ...
        evaluate: 'query {server} and save the result as {tag}',
        evaluateIncomplete: 'query a DNS server and save its result',
        respond: 'return the saved response {tag}',
      },
    },
    form: {
      ...
      fields: {
        ...
        match_response: 'Response Tag to Match',
        response_rcode: 'Required Response Code',
        race: 'Race Responses',
      },
      errors: {
        ...
        evaluateServerRequired: 'An evaluate action needs a DNS server.',
        evaluateTagRequired: 'An evaluate action needs a response tag.',
        matchResponseRequired: 'A respond action needs the response tag produced by evaluate.',
      },
