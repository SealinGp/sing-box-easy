...
export default {
  ...
  rules: {
    ...
    form: {
      ...
      queryTypePlaceholder: 'Any type (e.g. A, AAAA, HTTPS)',
      queryTypeHelp: 'Only match queries for these record types; leave empty to match every type. Combined with the other conditions using AND.',
    },
